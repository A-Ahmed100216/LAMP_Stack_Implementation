...
![Create volumes](/Project06/images/create_volumes.png)   
3. Attach the volumes to the webserver instance.
![Attach volumes](/Project06/images/attach_volumes.png)   
...
![lsblk after partitions](/Project06/images/lsblk_with_partitions.png)
10. Install lvm2 package via yum, the package manager for RedHat/CentOS.
```bash
sudo yum install lvm2
```
![install lvm2](/Project06/images/install_lvm2.png)        
11. Run `sudo lvmdiskscan` to check for available partitions.
![lvmdiskscan](/Project06/images/lvmdiskscan.png)       
...
![pvcreate](/Project06/images/pvcreate.png)       
...
sudo vgs
```
![vgcreate](/Project06/images/vgcreate.png)
...
![lvcreate](/Project06/images/lvcreate.png)
17. View the entire setup 
```
sudo vgdisplay -v
sudo lsblk
```
![setup web](/Project06/images/full_setup_web.png)
...
```
![ext4](/Project06/images/ext4.png)
...
```
![directories](/Project06/images/directories.png)
...
```
![mount app](/Project06/images/mount_app.png)
...
```
![mount logs](/Project06/images/mount_log.png)
...
![db initial partitions](/Project06/images/db_partitions.png)
![db lvs](/Project06/images/db_lvs.png)
![db setup](/Project06/images/db_setup.png)
...
```
![mysql status](/Project06/images/mysql_status.png)
...
exit
```
![configure db](/Project06/images/db_config.png)
...
![webserver sg](/Project06/images/webserver_sg.png)
...
![mysql connect via client](/Project06/images/mysql_client.png)
...
![db connection](/Project06/images/db_connection.png)
6. Provided the connection is successful, the following page should be displayed. 
![final webpage](/Project06/images/final_webpage.png)
